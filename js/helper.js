...
var HTMLheaderRole = '<span class="jobtitle">%data%</span><hr>';

var HTMLcontactGeneric = '<li class="flex-item"><span class="orange-text"><i class="small material-icons"> work</i>%contact%</span><span class="white-text">%data%</span></li>';
var HTMLmobile = '<li class="flex-item"><span class="orange-text"><i class="small material-icons">phone_android</i></span><span class="white-text">%data%</span></li>';
...
var HTMLprojectImage = '<a class="carousel-item" href="#%ordem%"><img src="%data%"></a>';
